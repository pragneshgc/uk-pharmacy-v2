...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/assets/js/components/pages/product/Import.vue?vue&type=script&lang=js&":
/*!**********************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/assets/js/components/pages/product/Import.vue?vue&type=script&lang=js& ***!
  \**********************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  "extends": _Modal_vue__WEBPACK_IMPORTED_MODULE_0__["default"],
  data: function data() {
    return {
      file: '',
      importing: false,
  ...
  methods: {
    ...
    attachFile: function attachFile() {
      ...
      axios.post('/inventory/products/import-preview', formData, {
        headers: {
    ...
    importFile: function importFile() {
      ...
      var formData = new FormData();
      formData.append('file', this.file);
      axios.post('/inventory/products/import-finish', formData, {
        headers: {
          'Content-type': 'multipart/form-data'
        }
      }).then(function (response) {
        _this2.importStage = 2;
        if (response.data.data.length > 0) {
          _this2.errors = response.data.data;
        }
      })["catch"](function (error) {});
    },
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/assets/js/components/pages/product/ProductEdit.vue?vue&type=script&lang=js&":
/*!***************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/assets/js/components/pages/product/ProductEdit.vue?vue&type=script&lang=js& ***!
  \***************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _mixins_logging__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../mixins/logging */ "./resources/assets/js/mixins/logging.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  mixins: [_mixins_print__WEBPACK_IMPORTED_MODULE_1__["default"], _mixins_logging__WEBPACK_IMPORTED_MODULE_2__["default"]],
  components: {
  ...
  computed: {
    ...
    optionsFiltered: function optionsFiltered() {
      ...
      if (this.type == 'country') {
        options = this.options.filter(function (item) {
          return item.Type == 2;
        });
  ...
  methods: {
    ...
    getCountryDetails: function getCountryDetails(data) {
      this.productCode = data;
      this.editing = false;
      this.type = 'country';
      this.productCodeId = this.productCode.ProductCodeID;
    ...
    getAlternativeNamesList: function getAlternativeNamesList() {
      var _this4 = this;
      axios.get("/inventory/products/".concat(this.productCodeId, "/alternative-names")).then(function (response) {
        _this4.alternativeNames = response.data.data;
      })["catch"](function (error) {
        console.log(error);
      });
    },
    getLogs: function getLogs() {
      var _this5 = this;
      axios.get("/inventory/products/".concat(this.productCodeId, "/logs")).then(function (response) {
        _this5.logs = response.data.data;
      })["catch"](function (error) {
        console.log(error);
      });
    },
    getDeliveryCompanies: function getDeliveryCompanies() {
      ...
      axios.get("/inventory/delivery/list").then(function (response) {
        _this6.deliveryCompanies = response.data.data;
        if (callback) {
          callback();
        }
      })["catch"](function (error) {
    ...
    getProductCode: function getProductCode() {
      ...
      axios.get("/inventory/products/".concat(this.productCodeId)).then(function (response) {
        _this8.productCode = response.data.data;
        _this8.getPacks();
      })["catch"](function (error) {
        console.log(error);
      });
    },
    getPacks: function getPacks() {
      var _this9 = this;
      axios.post("/inventory/products/packs", {
        code: this.productCode.Code
      }).then(function (response) {
        _this9.packs = response.data.data;
      })["catch"](function (error) {
        console.log(error);
      });
    },
    ...
    removePricing: function removePricing(value) {
      var _this10 = this;
      this.$swal({
        ...
        if (result.value) {
          axios["delete"]("/inventory/products/pricing/".concat(value.PricingID)).then(function (result) {
            _this10.$swal({
              title: 'Pricing removed',
              type: 'error',
              showConfirmButton: true
            });
            _this10.logSystemActivity(_this10.productCode.ProductCodeID, 5, 800, value, function () {
              _this10.getPriceList();
              _this10.getLogs();
            });
          })["catch"](function (error) {
            console.log(error);
    ...
    addPackProduct: function addPackProduct() {
      this.addedProduct = {
        Code: this.productCode.Code,
        Description: '',
        Quantity: 1,
    ...
    savePackProduct: function savePackProduct() {
      var _this11 = this;
      axios.post("/inventory/products/pack", this.addedProduct).then(function (response) {
        _this11.logSystemActivity(_this11.productCodeId, 5, 808, _this11.addedProduct, function () {
          _this11.getPriceList();
          _this11.getLogs();
        });
        _this11.addedProduct = false;
        _this11.$swal({
          title: 'Product Added',
          type: 'success',
          showConfirmButton: true
    ...
    removeProduct: function removeProduct(id) {
      ...
      this.$swal({
        ...
        if (result.value) {
          axios["delete"]("/inventory/products/pack/".concat(id)).then(function (result) {
            _this12.$swal({
              title: 'Product removed',
              type: 'error',
              showConfirmButton: true
            });
            _this12.logSystemActivity(_this12.productCodeId, 5, 809, _this12.productCode, function () {
              _this12.getPriceList();
              _this12.getLogs();
            });
          })["catch"](function (error) {
            console.log(error);
    ...
    removeAlternativeName: function removeAlternativeName(id) {
      var _this13 = this;
      this.$swal({
        ...
        if (result.value) {
          axios["delete"]("/inventory/products/alternative-names/".concat(id)).then(function (result) {
            _this13.$swal({
              title: 'Alternative name removed',
              type: 'error',
              showConfirmButton: true
            });
            _this13.getAlternativeNamesList();
          })["catch"](function (error) {
            console.log(error);
          });
        }
    ...
    deleteProduct: function deleteProduct() {
      ...
      this.$swal({
        ...
        if (result.value) {
          axios["delete"]("/inventory/products/".concat(_this14.productCodeId, "/delete")).then(function (result) {
            _this14.$swal({
              title: 'Product has been deactivated',
              type: 'error',
              showConfirmButton: true
            });
            _this14.logSystemActivity(_this14.productCodeId, 5, 801, _this14.productCode);
            _this14.getProductCode();
            _this14.$root.$emit('product.refresh');
          })["catch"](function (error) {
            console.log(error);
          });
        }
    ...
    reactivateProduct: function reactivateProduct() {
      ...
      this.$swal({
        ...
        if (result.value) {
          axios.post("/inventory/products/".concat(_this15.productCodeId, "/reactivate")).then(function (result) {
            _this15.$swal({
              title: 'Product has been reactivated',
              type: 'success',
              showConfirmButton: true
            });
            _this15.logSystemActivity(_this15.productCodeId, 5, 802, _this15.productCode);
            _this15.getProductCode();
            _this15.$root.$emit('product.refresh');
          })["catch"](function (error) {
            console.log(error);
          });
        }
    ...
    save: function save() {
      ...
      if (!this.productCodeId && this.type == 'country') {
        axios.post("/inventory/countries/pricing", this.form.country).then(function (result) {
          ...
          _this16.logSystemActivity(result.data.data, 5, 803, _this16.form.country);
          _this16.$root.$emit('product.refresh');
          _this16.clear();
        })["catch"](function (error) {
          console.log(error);
        });
        ...
        axios.post("/inventory/products/pricing", form).then(function (result) {
          ...
          _this16.logSystemActivity(_this16.productCode.ProductCodeID, 5, 804, form);
          _this16.$root.$emit('product.refresh');
          _this16.back();
        })["catch"](function (error) {
          console.log(error);
        ...
        axios.patch("/inventory/countries/pricing/".concat(this.pricingId), this.form.country).then(function (result) {
          ...
          var log = JSON.parse(JSON.stringify(_this16.form.country));
          log.pricingId = _this16.pricingId;
          _this16.logSystemActivity(_this16.productCode.ProductCodeID, 5, 806, log);
        ...
        axios.patch("/inventory/products/".concat(this.productCodeId), this.productCodeEdit).then(function (result) {
          ...
          _this16.$root.$emit('product.refresh');
          _this16.logSystemActivity(_this16.productCodeId, 5, 807, _this16.productCodeEdit);
          _this16.getOptions();
          _this16.back();
        })["catch"](function (error) {
        ...
        axios.patch("/inventory/products/".concat(this.productCodeId), this.productCodeEdit).then(function (result) {
          ...
          _this16.$root.$emit('product.refresh');
          _this16.logSystemActivity(_this16.productCodeId, 5, 810, _this16.productCodeEdit);
          _this16.back(2);
        })["catch"](function (error) {
          _this16.errors = error.response.data.errors;
        });
        ...
        axios.post("/inventory/products", this.productCodeEdit).then(function (result) {
          ...
          _this16.logSystemActivity(result.data.data, 5, 805, _this16.productCodeEdit);
          _this16.$root.$emit('product.refresh');
          _this16.clear();
          _this16.getOptions();
        })["catch"](function (error) {
    ...
    */
    ...
    addPricing: function addPricing() {
      ...
      if (this.clients.length == 0) {
        this.getClients(function () {
          _this17.editing = true;
          _this17.type = 'pricing';
        });
      } else {
        this.editing = true;
        this.type = 'pricing';
    ...
    changeStatus: function changeStatus(value) {
      var _this18 = this;
      axios.post("/inventory/products/pack/".concat(value.PackProductID, "/change-status")).then(function (result) {
        _this18.logSystemActivity(_this18.productCodeId, 5, 807, _this18.productCode);
        _this18.getPriceList();
        _this18.getLogs();
      })["catch"](function (error) {
        _this18.errors = error.response.data.errors;
      });
    },
    finishMove: function finishMove(e) {
      var _this19 = this;
      this.dragging = false;
      axios.post("/inventory/products/pack/ordering", {
        list: this.list
      }).then(function (response) {
        _this19.$toasted.show('Pack ordering updated', {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/assets/js/components/pages/product/Products.vue?vue&type=script&lang=js&":
/*!************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/assets/js/components/pages/product/Products.vue?vue&type=script&lang=js& ***!
  \************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _ProductEdit_vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ProductEdit.vue */ "./resources/assets/js/components/pages/product/ProductEdit.vue");
/* harmony import */ var _Import_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Import.vue */ "./resources/assets/js/components/pages/product/Import.vue");
//
//
//
//
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  components: {
    ProductEdit: _ProductEdit_vue__WEBPACK_IMPORTED_MODULE_0__["default"],
    Import: _Import_vue__WEBPACK_IMPORTED_MODULE_1__["default"]
  },
  data: function data() {
    return {
      loading: false,
      ...
      columns: {
        drug: ["Code", "Name", "Quantity", "Units", "Pouchable", "Product Type", "Package", "Reclassification", "Fridge", "TariffCode", "Price", "Options"],
  ...
  mounted: function mounted() {
    ...
    if (typeof this.$route.query.code != 'undefined') {
      if (this.$route.query.code != '') {
        axios.get("/inventory/products/".concat(this.$route.query.code)).then(function (response) {
          if (response.data.data != null) {
            _this.editProduct(response.data.data);
          }
        });
      }
    }
  ...
  computed: {
    ...
    searchString: function searchString() {
      var letter = "?letter=".concat(this.filter.letter);
      var company = "&company=".concat(this.filter.company);
      var additional = '';
      if (this.tab == 'drug') {
        additional = "&fridge=".concat(this.filter.fridge, "&type=").concat(this.filter.productType, "&code=").concat(this.filter.code.value, "\n                &reclassification=").concat(this.filter.reclassification, "&fdb=").concat(this.filter.fdb, "&name=").concat(this.filter.name.value, "&package=").concat(this.filter["package"], "&pouchable=").concat(this.filter.pouchable);
      }
  ...
  methods: {
    getProducts: function getProducts() {
      var _this2 = this;
      this.loading = true;
      axios.get("/inventory/products".concat(this.searchString)).then(function (response) {
    ...
    getCountries: function getCountries() {
      var _this3 = this;
      this.loading = true;
      axios.get("/inventory/countries".concat(this.searchString)).then(function (response) {
...
/***/ "./resources/assets/js/components/pages/product/Import.vue":
/*!*****************************************************************!*\
  !*** ./resources/assets/js/components/pages/product/Import.vue ***!
  \*****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _Import_vue_vue_type_template_id_f6abfdb2___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Import.vue?vue&type=template&id=f6abfdb2& */ "./resources/assets/js/components/pages/product/Import.vue?vue&type=template&id=f6abfdb2&");
/* harmony import */ var _Import_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Import.vue?vue&type=script&lang=js& */ "./resources/assets/js/components/pages/product/Import.vue?vue&type=script&lang=js&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! !../../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _Import_vue_vue_type_template_id_f6abfdb2___WEBPACK_IMPORTED_MODULE_0__.render,
  _Import_vue_vue_type_template_id_f6abfdb2___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/assets/js/components/pages/product/Import.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);

/***/ }),

/***/ "./resources/assets/js/components/pages/product/ProductEdit.vue":
/*!**********************************************************************!*\
  !*** ./resources/assets/js/components/pages/product/ProductEdit.vue ***!
  \**********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _ProductEdit_vue_vue_type_template_id_20987a87___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ProductEdit.vue?vue&type=template&id=20987a87& */ "./resources/assets/js/components/pages/product/ProductEdit.vue?vue&type=template&id=20987a87&");
/* harmony import */ var _ProductEdit_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ProductEdit.vue?vue&type=script&lang=js& */ "./resources/assets/js/components/pages/product/ProductEdit.vue?vue&type=script&lang=js&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! !../../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _ProductEdit_vue_vue_type_template_id_20987a87___WEBPACK_IMPORTED_MODULE_0__.render,
  _ProductEdit_vue_vue_type_template_id_20987a87___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/assets/js/components/pages/product/ProductEdit.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);

/***/ }),

/***/ "./resources/assets/js/components/pages/product/Products.vue":
/*!*******************************************************************!*\
  !*** ./resources/assets/js/components/pages/product/Products.vue ***!
  \*******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _Products_vue_vue_type_template_id_0e6c9634___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Products.vue?vue&type=template&id=0e6c9634& */ "./resources/assets/js/components/pages/product/Products.vue?vue&type=template&id=0e6c9634&");
/* harmony import */ var _Products_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Products.vue?vue&type=script&lang=js& */ "./resources/assets/js/components/pages/product/Products.vue?vue&type=script&lang=js&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! !../../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _Products_vue_vue_type_template_id_0e6c9634___WEBPACK_IMPORTED_MODULE_0__.render,
  _Products_vue_vue_type_template_id_0e6c9634___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/assets/js/components/pages/product/Products.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);
...
/***/ "./resources/assets/js/components/pages/product/Import.vue?vue&type=script&lang=js&":
/*!******************************************************************************************!*\
  !*** ./resources/assets/js/components/pages/product/Import.vue?vue&type=script&lang=js& ***!
  \******************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/assets/js/components/pages/product/ProductEdit.vue?vue&type=script&lang=js&":
/*!***********************************************************************************************!*\
  !*** ./resources/assets/js/components/pages/product/ProductEdit.vue?vue&type=script&lang=js& ***!
  \***********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/assets/js/components/pages/product/Products.vue?vue&type=script&lang=js&":
/*!********************************************************************************************!*\
  !*** ./resources/assets/js/components/pages/product/Products.vue?vue&type=script&lang=js& ***!
  \********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/assets/js/components/pages/product/Import.vue?vue&type=template&id=f6abfdb2&":
/*!************************************************************************************************!*\
  !*** ./resources/assets/js/components/pages/product/Import.vue?vue&type=template&id=f6abfdb2& ***!
  \************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Import_vue_vue_type_template_id_f6abfdb2___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Import_vue_vue_type_template_id_f6abfdb2___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Import_vue_vue_type_template_id_f6abfdb2___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Import.vue?vue&type=template&id=f6abfdb2& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/assets/js/components/pages/product/Import.vue?vue&type=template&id=f6abfdb2&");


/***/ }),

/***/ "./resources/assets/js/components/pages/product/ProductEdit.vue?vue&type=template&id=20987a87&":
/*!*****************************************************************************************************!*\
  !*** ./resources/assets/js/components/pages/product/ProductEdit.vue?vue&type=template&id=20987a87& ***!
  \*****************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ProductEdit_vue_vue_type_template_id_20987a87___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ProductEdit_vue_vue_type_template_id_20987a87___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ProductEdit_vue_vue_type_template_id_20987a87___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./ProductEdit.vue?vue&type=template&id=20987a87& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/assets/js/components/pages/product/ProductEdit.vue?vue&type=template&id=20987a87&");


/***/ }),

/***/ "./resources/assets/js/components/pages/product/Products.vue?vue&type=template&id=0e6c9634&":
/*!**************************************************************************************************!*\
  !*** ./resources/assets/js/components/pages/product/Products.vue?vue&type=template&id=0e6c9634& ***!
  \**************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Products_vue_vue_type_template_id_0e6c9634___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Products_vue_vue_type_template_id_0e6c9634___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Products_vue_vue_type_template_id_0e6c9634___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Products.vue?vue&type=template&id=0e6c9634& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/assets/js/components/pages/product/Products.vue?vue&type=template&id=0e6c9634&");
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/assets/js/components/pages/product/Import.vue?vue&type=template&id=f6abfdb2&":
/*!***************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/assets/js/components/pages/product/Import.vue?vue&type=template&id=f6abfdb2& ***!
  \***************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
          ...
          _c("div", { staticClass: "modal", class: _vm.modalClass }, [
            _c("div", { staticClass: "modal-header" }, [
              _c("p", { staticClass: "heading lead" }, [
                _c("b", [_vm._v("Add a new products by importing via csv")]),
              ]),
              _vm._v(" "),
              _c(
                "button",
                    ...
                    _vm.importStage == 0
                      ? _c("div", { staticClass: "pre-import" }, [
                          ...
                          _c(
                            ...
                            {
                              attrs: {
                                href: "/download/product-import-template",
                              },
                            },
                            [
                              _c(
                                ...
                                {
                                  staticClass:
                                    "btn btnSize01 secondaryBtn ml-10",
                                },
                                [
                                  _vm._v(
                      ...
                      ? _c(
                          ...
                          [
                            _c("h3", { staticClass: "text-center m-10" }, [
                              _vm._v(
                                '\n                            Importing file "' +
                                  _vm._s(_vm.inputText) +
                                  '"\n                        '
                              ),
                            ]),
                            _vm._v(" "),
                                ...
                                _c(
                                  ...
                                  [
                                    _c(
                                      "thead",
                                      {
                                        staticClass: "primary-color text-white",
                                      },
                                      [
                                        _c(
                                          "tr",
                      ...
                      : _vm.importStage == 2
                      ? _c("div", { staticClass: "post-import" }, [
                          _vm.errors.length == 0
                            ? _c("h3", { staticClass: "text-center m-10" }, [
                                _vm._v(
                                  "\n                            " +
                                  ...
                                  _c(
                                    ...
                                    [
                                      _c("h3", [
                                        ...
                                        _c("b", [
                                          _vm._v(_vm._s(_vm.data.data.length)),
                                        ]),
                                        _vm._v(" products were imported"),
                                      ]),
                                    ]
                                  ),
                                  _vm._v(" "),
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/assets/js/components/pages/product/ProductEdit.vue?vue&type=template&id=20987a87&":
/*!********************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/assets/js/components/pages/product/ProductEdit.vue?vue&type=template&id=20987a87& ***!
  \********************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      ? _c(
          ...
          [
            ...
            _c(
              ...
              {
                staticClass: "modal",
                attrs: { id: "product-modal", role: "document" },
              },
              [
                _c("div", { staticClass: "modal-header" }, [
                          ...
                          ? _c(
                              ...
                              [
                                _vm.userInfo.role > 4
                                  ...
                                  : _vm._e(),
                                _vm._v(" "),
                                _vm.productCode.Pack && _vm.userInfo.role > 4
                                  ? _c(
                                      "button",
                                      {
                                        staticClass:
                                          "ml-10 btn btnSize02 secondaryBtn",
                                        attrs: { title: "Save product" },
                                        on: {
                                          click: function ($event) {
                                            return _vm.addPackProduct()
                                          },
                                        },
                                      },
                                      [
                      ...
                      _c(
                        ...
                        [
                          _vm.productCodeId && !_vm.pricingId && !_vm.editing
                                    ...
                                    [
                                      _c(
                                        ...
                                        [
                                          ...
                                          _vm._v(" "),
                                          _vm.list.length == 0
                                            ? _c("th", [_vm._v("ProductCode")])
                                            : _vm._e(),
                                          _vm._v(" "),
                                          _vm.list.length == 0
                                            ? _c("th", [
                                                _vm._v("Print Instruction"),
                                              ])
                                            : _vm._e(),
                                          _vm._v(" "),
                                          _vm.productCode.Pack
                                            ? _c("th", [_vm._v("Status")])
                                            : _vm._e(),
                                          _vm._v(" "),
                                      ...
                                      _vm._v(" "),
                                      _vm.addedProduct && _vm.productCode.Pack
                                        ? _c("tr", [
                                            _c("td", [
                                              _vm._v(
                                                _vm._s(_vm.addedProduct.Code)
                                              ),
                                            ]),
                                            _vm._v(" "),
                                            _c("td", [
                                              _c(
                                                "select",
                                                {
                                                  ...
                                                  staticClass:
                                                    "ml-10 browser-default custom-select",
                                                  attrs: {
                                                    name: "Description",
                                                  },
                                                  on: {
                            ...
                            ? _c(
                                "div",
                                { staticClass: "pxp-form address-form" },
                                [
                            ...
                            ? _c(
                                ...
                                [
                                            ...
                                            directives: [
                                              {
                                                ...
                                                rawName: "v-model",
                                                value:
                                                  _vm.productCodeEdit.Units,
                                                expression:
                                                  "productCodeEdit.Units",
                                              },
                                            ],
                                            staticClass: "form-control mb-3",
                                            attrs: {
                                  ...
                                  _vm._v(" "),
                                  _c("div", { staticClass: "form-row" }, [
                                    _c("h3", [_vm._v("Pricing Information")]),
                                    _vm._v(" "),
                                    _c("div", { staticClass: "form-column" }, [
                                      !_vm.productCodeId
                                        ? _c(
                                      ...
                                      _c(
                                        ...
                                        [
                                          ...
                                          _c("input", {
                                            ...
                                            domProps: {
                                              value:
                                                _vm.productCodeEdit.TariffCode,
                                            },
                                            on: {
                                              input: function ($event) {
                                                if ($event.target.composing) {
                                              ...
                                              directives: [
                                                {
                                                  ...
                                                  value:
                                                    _vm.productCodeEdit
                                                      .PrintForm,
                                                  expression:
                                                    "productCodeEdit.PrintForm",
                                                },
                                              ],
                                              staticClass:
                                                "browser-default custom-select",
                                              attrs: { name: "PrintForm" },
                                              on: {
                                                change: function ($event) {
                                                  var $$selectedVal =
                                                    Array.prototype.filter
                                              ...
                                              directives: [
                                                {
                                                  ...
                                                  rawName: "v-model",
                                                  value:
                                                    _vm.productCodeEdit.Pack,
                                                  expression:
                                                    "productCodeEdit.Pack",
                                                },
                                              ],
                                              staticClass:
                                                "browser-default custom-select",
                                          ...
                                          _c(
                                            ...
                                            [
                                              _c(
                                                "option",
                                                { attrs: { value: "1" } },
                                                [_vm._v("Pouchable (Always)")]
                                              ),
                                              _vm._v(" "),
                                              _c(
                                                "option",
                                                { attrs: { value: "0" } },
                                                [_vm._v("Pouchable (Manual)")]
                                              ),
                                              _vm._v(" "),
                                              _c(
                                                "option",
                                                { attrs: { value: "2" } },
                                                [_vm._v("Pouchable (Disabled)")]
                                              ),
                                            ]
                                          ),
                                          _vm._v(" "),
                              ...
                              ? _c(
                                  ...
                                  [
                                    _c(
                                      ...
                                      [_vm._v("Alternative Names/Aliases")]
                                    ),
                                    _vm._v(" "),
                                    _c(
                                      "table",
                                                    ...
                                                    _vm.userInfo.role > 4
                                                      ? _c(
                                                          "button",
                                                          {
                                                            ...
                                                            attrs: {
                                                              title:
                                                                "Remove alternative product name",
                                                            },
                                                            on: {
                                                              click: function (
                                                                $event
                                                              ) {
                                                                return _vm.removeAlternativeName(
                                      ...
                                      [
                                        ...
                                        _c(
                                          ...
                                          _vm._l(_vm.packs, function (pack) {
                                            return _c(
                                              "tr",
                                              { key: pack.ProductCodeID },
                                              [
                                                _c("td", [
                                                  _vm._v(_vm._s(pack.Code)),
                                                ]),
                                                _vm._v(" "),
                                                _c("td", [
                ...
                _c("div", { staticClass: "modal-footer" }, [
                  _vm.editing &&
                  ((_vm.type == "product" &&
                    !_vm.isEqual(_vm.productCode, _vm.productCodeEdit)) ||
                    (_vm.type == "country" &&
                      !_vm.isEqual(_vm.form.country, _vm.form.bufferCountry)) ||
                    _vm.type == "pricing")
                    ? _c(
                        "button",
                        {
                  ...
                  _vm.userInfo.role > 4
                    ...
                    : _vm._e(),
                  _vm._v(" "),
                  _vm.editing && _vm.productCodeId && _vm.userInfo.role > 4
                    ? _c(
                        "button",
                        {
                          staticClass: "btn btnSize02 secondaryBtn",
                          ...
                          on: {
                            click: function ($event) {
                              return _vm.back(_vm.productCode.Type)
                            },
                          },
                        },
                        [_vm._v("\n                    Back\n                ")]
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/assets/js/components/pages/product/Products.vue?vue&type=template&id=0e6c9634&":
/*!*****************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/assets/js/components/pages/product/Products.vue?vue&type=template&id=0e6c9634& ***!
  \*****************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
    ...
    [
      _c("section", { staticClass: "card" }, [
        ...
        _c("div", { staticClass: "products-header" }, [
          _c("div", { staticClass: "products-navigation" }, [
            _c("div", { staticClass: "navigation-wrapper" }, [
              _c("ul", { staticClass: "products-tab" }, [
                _c(
                  "li",
                  {
                    staticClass: "products-tab-item clickable",
                    class: [_vm.tab == "drug" ? "active" : ""],
                ...
                _vm._v(" "),
                _c("li", { staticClass: "products-tab-item" }, [
                  _c(
                    "select",
                    {
                      directives: [
                    ...
                    [
                      ...
                      _vm._v(" "),
                      _c("option", { attrs: { value: "DISCONTINUED" } }, [
                        _vm._v("DISCONTINUED"),
                      ]),
                      _vm._v(" "),
                      _c("option", { attrs: { value: "NOTPRICED" } }, [
                        _vm._v("NOT PRICED"),
                      ]),
                      _vm._v(" "),
                      ...
                      _vm._v(" "),
                      _c("option", { attrs: { value: "34" } }, [_vm._v("DMS")]),
                      _vm._v(" "),
                ...
                _c("li", { staticClass: "products-tab-item" }, [
                  _c(
                      ...
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.filter.fdb,
                          expression: "filter.fdb",
                        },
                      ],
                      staticClass: "browser-default custom-select",
                      staticStyle: { width: "200px" },
                      attrs: { disabled: _vm.tab != "drug", name: "FDB" },
                      on: {
                        change: function ($event) {
                          var $$selectedVal = Array.prototype.filter
                            .call($event.target.options, function (o) {
                    ...
                    [
                      ...
                      _vm._v(" "),
                      _c("option", { attrs: { value: "1" } }, [_vm._v("ESA")]),
                      _vm._v(" "),
                      _c("option", { attrs: { value: "2" } }, [_vm._v("FDB")]),
                    ]
                  ),
                ]),
                _vm._v(" "),
            ...
            _c(
              ...
              [
                _vm.userInfo.role > 4
                  ? _c(
                      "button",
                      {
                        ...
                        on: {
                          click: function ($event) {
                            return _vm.openEditModal("product")
                          },
                        },
                      },
                      [
                ...
                _c(
                  ...
                  {
                    staticClass: "btn btnSize02 secondaryBtn",
                    attrs: { title: "Download CSV", href: _vm.csvUrl },
                  },
                  [
          ...
          _c(
            "div",
            { staticClass: "products-letter-filter mt-10 mb-10" },
            [
              _c(
                "button",
                {
                  staticClass: "products-button ml-10",
                  class: [
                    !_vm.filter.letter || _vm.filter.letter == "all"
                      ? "active"
                      : "",
                  ],
                  on: {
                    click: function ($event) {
                      _vm.filter.letter = "all"
                    },
                  },
                },
                [_vm._v("\n                    All\n                ")]
              ...
              _c(
                "button",
                {
                  staticClass: "products-button ml-5",
                  class: [_vm.filter.letter == "number" ? "active" : ""],
                  on: {
                    click: function ($event) {
                      _vm.filter.letter = "number"
                    },
                  },
                },
                [_vm._v("\n                    0-9\n                ")]
              ...
              _vm._l(_vm.alphabet, function (letter) {
                return _c(
                  "button",
                  {
                    key: letter,
                    staticClass: "products-button ml-5",
                    class: [_vm.filter.letter == letter ? "active" : ""],
                    on: {
                      click: function ($event) {
                        _vm.filter.letter = letter
                      },
                    },
                  },
                  [
        ...
        _c("div", { staticClass: "card-body" }, [
          _c(
            "div",
            { staticClass: "products-body", attrs: { id: "products-table" } },
            [
              _vm.tab == "drug"
                ? _c(
                    "table",
                    ...
                    [
                      _c(
                        ...
                        {
                          staticClass: "primary-color text-white",
                          staticStyle: { top: "0", position: "sticky" },
                        },
                        [
                          _c(
                            "tr",
                                ...
                                value == "Product Type"
                                        ...
                                        directives: [
                                          {
                                            name: "model",
                                            rawName: "v-model",
                                            value: _vm.filter.productType,
                                            expression: "filter.productType",
                                          },
                                        ],
                                        staticClass: "product-table-select",
                                        on: {
                                          change: function ($event) {
                                            var $$selectedVal =
                                              Array.prototype.filter
                                        ...
                                        directives: [
                                          {
                                            name: "model",
                                            rawName: "v-model",
                                            value: _vm.filter.fridge,
                                            expression: "filter.fridge",
                                          },
                                        ],
                                        staticClass: "product-table-select",
                                        on: {
                                        ...
                                        directives: [
                                          {
                                            name: "model",
                                            rawName: "v-model",
                                            value: _vm.filter.reclassification,
                                            expression:
                                              "filter.reclassification",
                                          },
                                        ],
                                        staticClass: "product-table-select",
                                        on: {
                                  ...
                                  ? _c(
                                      "div",
                                      {
                                        ...
                                        attrs: { title: "Filter by Name" },
                                      },
                                      [
                                        _vm.filter.name.status
                                          ? _c("div", [
                                              _c(
                                                "form",
                                                {
                                  ...
                                  ? _c(
                                      ...
                                      {
                                        staticClass: "clickable",
                                        attrs: { title: "Filter by Code" },
                                      },
                                      [
                                        _vm.filter.code.status
                                          ? _c("div", [
                                              _c(
                                                "form",
                                                {
                      ...
                      _vm.products.length > 0
                        ? _c(
                            "tbody",
                            _vm._l(_vm.visibleProducts, function (value) {
                              return _c(
                                "tr",
                                { key: value.ProductCodeID },
                                [
                                  _vm._l(value, function (v, k) {
                                    return !_vm.hiddenColumns.includes(k)
                                      ? _c("td", { key: k }, [
                                          _c("span", {
                    ...
                    [
                      _c("thead", { staticClass: "primary-color text-white" }, [
                        _c(
                          "tr",
                          [
                            _vm._l(_vm.countries[0], function (value, key) {
                              return !_vm.hiddenColumns.includes(key)
                                ? _c("th", { key: key }, [
                                    _vm._v(
                                      "\n                                " +
                                        _vm._s(key) +
                      ...
                      _c(
                        "tbody",
                        _vm._l(_vm.countries, function (value) {
                          return _c(
                            "tr",
                            { key: value.ProductCodeID },
                            [
                              ...
                              _c("td", [
                                _c(
                                  "button",
                                  {
                                    ...
                                    attrs: { title: "View delivery pricing" },
                                    on: {
                                      click: function ($event) {
                                        return _vm.editCountry(value)
                                      },
                                    },
                                  },
                                  [_c("i", { staticClass: "fa fa-info" })]
      ...
      _c("ProductEdit"),
      _vm._v(" "),
      _c("Import", { attrs: { "modal-name": "import" } }),
    ],
    1
  )
}
