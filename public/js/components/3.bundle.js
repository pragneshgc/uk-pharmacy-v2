...
exports.default = {
    ...
    data: function data() {
        return {
            prescriberForm: {
                options: [{ name: '[REJECT] Too many ordered', value: 1, limit: 30 }, { name: '[REJECT] Dosage problem', value: 2, limit: 30 }, { name: '[POSTPONE] Ordered too early', value: 3, limit: 30 }, { name: '[QUERY] Miscellaneous', value: 4, limit: 30 }, { name: '[QUERY] Dosage problem', value: 5, limit: 30 }, { name: '[QUERY] Potential name discrepancy', value: 6, limit: 0 }],
                select: 0,
                message: '',
                date: ''
            },
    ...
    methods: {
        submit: function submit() {
            ...
            axios.post('/mail/' + this.orderID + '/contact', { form: this.prescriberForm }).then(function (response) {
                ...
                _this.$root.$emit('tray.remove', _this.orderID); //remove from tray when queried
                _this.resetForm();
                _this.show.modal = false;
