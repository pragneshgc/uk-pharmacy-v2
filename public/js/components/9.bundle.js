...
/***/ "./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"],\"uglify\":true}}],\"babel-preset-env\"],\"plugins\":[\"transform-object-rest-spread\",[\"transform-runtime\",{\"polyfill\":false,\"helpers\":false}],\"babel-plugin-syntax-dynamic-import\"]}!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./resources/assets/js/components/NoteModal.vue":
/***/ (function(module, exports, __webpack_require__) {
...
var _vue2Editor = __webpack_require__("./node_modules/vue2-editor/dist/vue2-editor.esm.js");
...
exports.default = {
    ...
    data: function data() {
        return {
            form: {
                options: [{ name: 'Patient Note <span style="font-style: italic;">(Patient specific notes)</span>', value: 1 }, { name: 'Query Note', value: 2 }, { name: 'Order Note <span style="font-size: 13px;">(Order specific notes)</span>', value: 3 }],
                Type: 0,
                Note: '',
                Alert: false,
        ...
        options: function options() {
            if (!this.preimport) {
                if (this.userInfo.role == 30) {
                    ...
                    return [{ name: 'Order Note <span style="font-size: 13px;">(Order specific notes)</span>', value: 3 }, { name: 'Patient Note <span style="font-size: 13px;">(Patient specific notes)</span>', value: 1 }];
                }
            } else {
                return [{ name: 'Subscription Note', value: 4 }, { name: 'Order Note', value: 3 }];
            }
        }
    },
    mounted: function mounted() {
    ...
    watch: {
        'form.ReferenceNumber': _.debounce(function () {
            ...
            if (this.form.ReferenceNumber) {
                axios.get('/order/' + this.form.ReferenceNumber + '/exists').then(function (response) {
    ...
    methods: {
        ...
        update: function update(id) {
            ...
            axios.patch('/note/' + this.form.NoteID, this.form).then(function (response) {
...
/***/ "./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-26724798\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./resources/assets/js/components/NoteModal.vue":
/***/ (function(module, exports, __webpack_require__) {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-26724798", module.exports)
  }
}
...
/* harmony reexport (default from non-hamory) */ __webpack_require__.d(__webpack_exports__, "Quill", function() { return __WEBPACK_IMPORTED_MODULE_0_quill___default.a; });
/*!
 * vue2-editor v2.10.3 
 * (c) 2021 David Royer
...
var __vue_script__ = __webpack_require__("./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"],\"uglify\":true}}],\"babel-preset-env\"],\"plugins\":[\"transform-object-rest-spread\",[\"transform-runtime\",{\"polyfill\":false,\"helpers\":false}],\"babel-plugin-syntax-dynamic-import\"]}!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./resources/assets/js/components/NoteModal.vue")
/* template */
var __vue_template__ = __webpack_require__("./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-26724798\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./resources/assets/js/components/NoteModal.vue")
/* template functional */
var __vue_template_functional__ = false
/* styles */
var __vue_styles__ = null
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-26724798", Component.options)
  } else {
    hotAPI.reload("data-v-26724798", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
