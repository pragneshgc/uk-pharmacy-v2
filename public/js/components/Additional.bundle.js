...
/***/ "./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"],\"uglify\":true}}],\"babel-preset-env\"],\"plugins\":[\"transform-object-rest-spread\",[\"transform-runtime\",{\"polyfill\":false,\"helpers\":false}],\"babel-plugin-syntax-dynamic-import\"]}!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./resources/assets/js/components/pages/additional/Additional.vue":
...
var _AdditionalEdit = __webpack_require__("./resources/assets/js/components/pages/additional/AdditionalEdit.vue");

var _AdditionalEdit2 = _interopRequireDefault(_AdditionalEdit);
...
__webpack_require__("./node_modules/@emacle/vue-treeselect/dist/vue-treeselect.css");
...
exports.default = {
    components: {
        AdditionalEdit: _AdditionalEdit2.default, Treeselect: _vueTreeselect2.default
    },
    mixins: [_errors2.default, _logging2.default],
    data: function data() {
        return {
            loading: false,
    ...
    computed: {
        ...
        searchString: function searchString() {
            var product = '?product=' + this.productFilter;
    ...
    methods: {
        ...
        getLabels: function getLabels() {
            ...
            this.loading = true;
            axios.get('/additional-information' + this.searchString).then(function (response) {
        ...
        updateLabel: function updateLabel(label) {
            ...
            axios.patch('/additional-information/' + label.AIID, label).then(function (response) {
        ...
        deleteLabel: function deleteLabel(label) {
            ...
            this.$swal({
                ...
                if (result.value) {
                    axios.delete('/additional-information/' + label.AIID).then(function (response) {
        ...
        removeProduct: function removeProduct(productCodeId, group) {
            ...
            this.$swal({
                ...
                if (result.value) {
                    axios.delete('/additional-information/group/' + group + '/products/' + productCodeId).then(function (response) {
        ...
        addProduct: function addProduct(productCodeId, group) {
            ...
            axios.put('/additional-information/group/' + group + '/products/' + productCodeId).then(function (response) {
                _this9.getProducts(group);
                // this.labels.splice(this.labels.findIndex(item => item.AIID === label.AIID), 1);

                _this9.logSystemActivity(productCodeId, 6, 903, { group: group, productCodeId: productCodeId });
        ...
        getProducts: function getProducts(id) {
            ...
            axios.get('/additional-information/group/' + id + '/products').then(function (response) {
        ...
        check: function check(id, status) {
            ...
            if (status == 1) {
                axios.post('/additional-information/' + id + '/disable').then(function (response) {
                ...
                axios.post('/additional-information/' + id + '/enable').then(function (response) {
        ...
        checkProduct: function checkProduct(code, group, status) {
            ...
            if (status == 1) {
                axios.post('/additional-information/' + group + '/disable/product', { code: code }).then(function (response) {
                ...
                axios.post('/additional-information/' + group + '/enable/product', { code: code }).then(function (response) {
...
/***/ "./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"],\"uglify\":true}}],\"babel-preset-env\"],\"plugins\":[\"transform-object-rest-spread\",[\"transform-runtime\",{\"polyfill\":false,\"helpers\":false}],\"babel-plugin-syntax-dynamic-import\"]}!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./resources/assets/js/components/pages/additional/AdditionalEdit.vue":
/***/ (function(module, exports, __webpack_require__) {
    ...
    methods: {
        ...
        removePricing: function removePricing(id) {
            ...
            this.$swal({
                ...
                if (result.value) {
                    axios.delete('/inventory/products/pricing/' + id).then(function (result) {
                        _this7.$swal({
        ...
        deleteProduct: function deleteProduct() {
            ...
            this.$swal({
                ...
                if (result.value) {
                    axios.delete('/inventory/products/' + _this8.productCodeId + '/delete').then(function (result) {
                        _this8.$swal({
        ...
        reactivateProduct: function reactivateProduct() {
            ...
            this.$swal({
                ...
                if (result.value) {
                    axios.post('/inventory/products/' + _this9.productCodeId + '/reactivate').then(function (result) {
                        _this9.$swal({
...
/***/ "./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-62bd6246\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./resources/assets/js/components/pages/additional/Additional.vue":
/***/ (function(module, exports, __webpack_require__) {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-62bd6246", module.exports)
  }
}

/***/ }),

/***/ "./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-76ef6187\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./resources/assets/js/components/pages/additional/AdditionalEdit.vue":
/***/ (function(module, exports, __webpack_require__) {
                                      ...
                                      directives: [
                                        {
                                          ...
                                          expression: "productCodeEdit.Quantity"
                                        }
                                      ],
                                      staticClass: "form-control mb-3",
                                      attrs: {
                                        ...
                                        directives: [
                                          {
                                            ...
                                            expression: "productCodeEdit.Status"
                                          }
                                        ],
                                        staticClass:
                                          "browser-default custom-select",
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-76ef6187", module.exports)
  }
}
...
/* template */
var __vue_template__ = __webpack_require__("./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-62bd6246\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./resources/assets/js/components/pages/additional/Additional.vue")
/* template functional */
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-62bd6246", Component.options)
  } else {
    hotAPI.reload("data-v-62bd6246", Component.options)
  }
...
var __vue_script__ = __webpack_require__("./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"],\"uglify\":true}}],\"babel-preset-env\"],\"plugins\":[\"transform-object-rest-spread\",[\"transform-runtime\",{\"polyfill\":false,\"helpers\":false}],\"babel-plugin-syntax-dynamic-import\"]}!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./resources/assets/js/components/pages/additional/AdditionalEdit.vue")
/* template */
var __vue_template__ = __webpack_require__("./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-76ef6187\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./resources/assets/js/components/pages/additional/AdditionalEdit.vue")
/* template functional */
var __vue_template_functional__ = false
/* styles */
var __vue_styles__ = null
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-76ef6187", Component.options)
  } else {
    hotAPI.reload("data-v-76ef6187", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
