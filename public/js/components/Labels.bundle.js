...
/***/ "./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"],\"uglify\":true}}],\"babel-preset-env\"],\"plugins\":[\"transform-object-rest-spread\",[\"transform-runtime\",{\"polyfill\":false,\"helpers\":false}],\"babel-plugin-syntax-dynamic-import\"]}!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./resources/assets/js/components/pages/label/LabelEdit.vue":
...
/***/ "./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"],\"uglify\":true}}],\"babel-preset-env\"],\"plugins\":[\"transform-object-rest-spread\",[\"transform-runtime\",{\"polyfill\":false,\"helpers\":false}],\"babel-plugin-syntax-dynamic-import\"]}!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./resources/assets/js/components/pages/label/Labels.vue":
/***/ (function(module, exports, __webpack_require__) {
...
var _LabelEdit = __webpack_require__("./resources/assets/js/components/pages/label/LabelEdit.vue");
...
exports.default = {
    components: {
        LabelEdit: _LabelEdit2.default, Treeselect: _vueTreeselect2.default
    },
    ...
    methods: {
        ...
        getLabels: function getLabels() {
            ...
            this.loading = true;
            axios.get('/labels' + this.searchString).then(function (response) {
        ...
        updateLabel: function updateLabel(label) {
            ...
            axios.patch('/labels/' + label.WLID, label).then(function (response) {
        ...
        deleteLabel: function deleteLabel(label) {
            ...
            this.$swal({
                ...
                if (result.value) {
                    axios.delete('/labels/' + label.WLID).then(function (response) {
        ...
        removeProduct: function removeProduct(productCodeId, group) {
            ...
            this.$swal({
                ...
                if (result.value) {
                    axios.delete('/labels/group/' + group + '/products/' + productCodeId).then(function (response) {
                        _this8.getProducts(group);
                        _this8.logSystemActivity(productCodeId, 6, 602, { group: group, productCodeId: productCodeId });
        ...
        addProduct: function addProduct(productCodeId, group) {
            ...
            axios.put('/labels/group/' + group + '/products/' + productCodeId).then(function (response) {
                _this9.getProducts(group);
                _this9.logSystemActivity(productCodeId, 6, 603, { group: group, productCodeId: productCodeId });
                // this.labels.splice(this.labels.findIndex(item => item.WLID === label.WLID), 1);
        ...
        getProducts: function getProducts(id) {
            ...
            axios.get('/labels/group/' + id + '/products').then(function (response) {
        ...
        check: function check(id, status) {
            ...
            if (status == 1) {
                axios.post('/labels/' + id + '/disable').then(function (response) {
                ...
                axios.post('/labels/' + id + '/enable').then(function (response) {
        ...
        checkProduct: function checkProduct(code, group, status) {
            ...
            if (status == 1) {
                axios.post('/labels/' + group + '/disable/product', { code: code }).then(function (response) {
                    _this13.logSystemActivity(group, 6, 605, { code: code, group: group });
                ...
                axios.post('/labels/' + group + '/enable/product', { code: code }).then(function (response) {
                    _this13.logSystemActivity(group, 6, 606, { code: code, group: group });
...
/***/ "./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-6007c7d1\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./resources/assets/js/components/pages/label/LabelEdit.vue":
/***/ (function(module, exports, __webpack_require__) {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-6007c7d1", module.exports)
  }
}

/***/ }),

/***/ "./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-648c7bdc\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./resources/assets/js/components/pages/label/Labels.vue":
/***/ (function(module, exports, __webpack_require__) {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-648c7bdc", module.exports)
  }
}
...
/* template */
var __vue_template__ = __webpack_require__("./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-6007c7d1\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./resources/assets/js/components/pages/label/LabelEdit.vue")
/* template functional */
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6007c7d1", Component.options)
  } else {
    hotAPI.reload("data-v-6007c7d1", Component.options)
  }
...
var __vue_script__ = __webpack_require__("./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"],\"uglify\":true}}],\"babel-preset-env\"],\"plugins\":[\"transform-object-rest-spread\",[\"transform-runtime\",{\"polyfill\":false,\"helpers\":false}],\"babel-plugin-syntax-dynamic-import\"]}!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./resources/assets/js/components/pages/label/Labels.vue")
/* template */
var __vue_template__ = __webpack_require__("./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-648c7bdc\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./resources/assets/js/components/pages/label/Labels.vue")
/* template functional */
var __vue_template_functional__ = false
/* styles */
var __vue_styles__ = null
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-648c7bdc", Component.options)
  } else {
    hotAPI.reload("data-v-648c7bdc", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
