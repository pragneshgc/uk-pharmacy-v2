(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_assets_js_components_NoteModal_vue"],{
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/assets/js/components/NoteModal.vue?vue&type=script&lang=js&":
/*!***********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/assets/js/components/NoteModal.vue?vue&type=script&lang=js& ***!
  \***********************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    return {
      form: {
        options: [{
          name: 'Patient Note <span style="font-style: italic;">(Patient specific notes)</span>',
          value: 1
        }, {
          name: 'Query Note',
          value: 2
        }, {
          name: 'Order Note <span style="font-size: 13px;">(Order specific notes)</span>',
          value: 3
        }],
        Type: 0,
        Note: '',
      ...
      if (!this.preimport) {
        if (this.userInfo.role == 30) {
          ...
          return [{
            ...
            name: 'Patient Note <span style="font-size: 13px;">(Patient specific notes)</span>',
            value: 1
          }];
        }
      } else {
  ...
  mounted: function mounted() {
    var _this = this;
    this.$root.$on('modal.open', function (name, note) {
      if (name == _this.modalName) {
        _this.show.modal = true;
      }
      if (note && note != 'preimport' && note.Type != 3 && note.Type != 4) {
        _this.editing = note;
        _this.form.Type = note.Type;
        _this.form.Note = note.Note;
        _this.form.Alert = note.Alert == 0 ? false : true;
        console.log('the note is this');
      } else if (note && (note.Type == 3 || note.Type == 4)) {
        _this.editing = note;
        _this.form.Type = note.Type;
        _this.form.Note = note.Note;
        _this.form.Alert = true;
        _this.preimport = true;
        _this.form.ReferenceNumber = note.ReferenceNumber;
      } else if (note == 'preimport') {
        _this.form.Type = 4;
        _this.form.Note = '';
        _this.form.Alert = true;
        _this.form.ReferenceNumber = '';
        _this.form.Subscription = '';
        _this.preimport = true;
      }
    });
    this.$root.$on('modal.close', function (name) {
  ...
  watch: {
    'form.ReferenceNumber': _.debounce(function () {
      ...
      if (this.form.ReferenceNumber) {
        axios.get("/order/".concat(this.form.ReferenceNumber, "/exists")).then(function (response) {
          if (response.data.data) {
            _this2.error = 'This Reference Number is already in the system!';
          } else {
            _this2.error = '';
          }
    ...
    'show.modal': function showModal() {
      var _this3 = this;
      setTimeout(function () {
        if (_this3.show.modal && !_this3.dragEventTriggered && document.getElementById("draggable-div-note")) {
          ...
          _this3.dragEventTriggered = true;
        } else {
          _this3.dragEventTriggered = false;
          _this3.backdrop = true;
        }
      }, 300);
    }
  },
  methods: {
    ...
    update: function update(id) {
      ...
      axios.patch("/note/".concat(this.form.NoteID), this.form).then(function (response) {
...
/***/ "./resources/assets/js/components/NoteModal.vue":
/*!******************************************************!*\
  !*** ./resources/assets/js/components/NoteModal.vue ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _NoteModal_vue_vue_type_template_id_26724798___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./NoteModal.vue?vue&type=template&id=26724798& */ "./resources/assets/js/components/NoteModal.vue?vue&type=template&id=26724798&");
/* harmony import */ var _NoteModal_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./NoteModal.vue?vue&type=script&lang=js& */ "./resources/assets/js/components/NoteModal.vue?vue&type=script&lang=js&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! !../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _NoteModal_vue_vue_type_template_id_26724798___WEBPACK_IMPORTED_MODULE_0__.render,
  _NoteModal_vue_vue_type_template_id_26724798___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/assets/js/components/NoteModal.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);
...
/***/ "./resources/assets/js/components/NoteModal.vue?vue&type=script&lang=js&":
/*!*******************************************************************************!*\
  !*** ./resources/assets/js/components/NoteModal.vue?vue&type=script&lang=js& ***!
  \*******************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_NoteModal_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./NoteModal.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/assets/js/components/NoteModal.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_NoteModal_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 
...
/***/ "./resources/assets/js/components/NoteModal.vue?vue&type=template&id=26724798&":
/*!*************************************************************************************!*\
  !*** ./resources/assets/js/components/NoteModal.vue?vue&type=template&id=26724798& ***!
  \*************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_NoteModal_vue_vue_type_template_id_26724798___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_NoteModal_vue_vue_type_template_id_26724798___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_NoteModal_vue_vue_type_template_id_26724798___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./NoteModal.vue?vue&type=template&id=26724798& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/assets/js/components/NoteModal.vue?vue&type=template&id=26724798&");
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/assets/js/components/NoteModal.vue?vue&type=template&id=26724798&":
/*!****************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/assets/js/components/NoteModal.vue?vue&type=template&id=26724798& ***!
  \****************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  return _c("transition", { attrs: { name: "fade" } }, [
    _vm.show.modal
      ? _c("div", { staticClass: "esa-modal" }, [
          ...
          _c(
            "div",
            { staticClass: "modal", attrs: { id: "draggable-div-note" } },
            [
              _c(
                "div",
                {
                  staticClass: "modal-header draggable-div-header",
                  attrs: { id: "draggable-div-header-note" },
                },
                [_c("h3", [_vm._v("Create Note")])]
              ),
              _vm._v(" "),
              _c("div", { staticClass: "modal-body" }, [
                _c(
                  ...
                  [
                    _c("label", { attrs: { for: "note-select" } }, [
                      _vm._v("Note type "),
                      _c("small", { staticClass: "danger" }, [
                        _vm._v("(required)"),
                      ]),
                    ]),
                    _vm._v(" "),
                    _c(
                      "select",
                      {
                        ...
                        staticClass: "table-dropdown mb-10",
                        attrs: { name: "note-select" },
                        on: {
                    ...
                    _vm._v(" "),
                    [1, 3].includes(_vm.form.Type) /* form.Type == 3 */ &&
                    !_vm.preimport
                      ? _c("input", {
                          class: { unchecked: !_vm.form.Alert },
                          attrs: { type: "checkbox", name: "specific" },
                          domProps: { checked: _vm.form.Alert },
                        })
                      : _vm._e(),
                    _vm._v(" "),
                    [1, 3].includes(_vm.form.Type) /* form.Type == 3 */ &&
                    !_vm.preimport
                      ? _c(
                          "label",
                          {
                            ...
                            attrs: {
                              title:
                                "Show in a popup to other users when they view this prescription.",
                              for: "specific",
                            },
                            on: {
                              click: function ($event) {
                                _vm.form.Alert = !_vm.form.Alert
                              },
                            },
                          },
                          [_c("b", [_vm._v("Alert other users")])]
                        )
                      : _vm._e(),
                    _vm._v(" "),
                    _vm.preimport && !_vm.editing && _vm.form.Type != 4
                      ? _c("label", { attrs: { for: "reference-number" } }, [
                    ...
                    _vm.preimport && !_vm.editing && _vm.form.Type != 4
                      ? _c("input", {
                          ...
                          attrs: { name: "reference-number", type: "text" },
                          domProps: { value: _vm.form.ReferenceNumber },
                          on: {
                    ...
                    _vm.preimport && !_vm.editing && _vm.form.Type == 4
                          ...
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.form.Subscription,
                              expression: "form.Subscription",
                            },
                          ],
                          staticClass: "form-control tBoxSize02 mb-10",
                          attrs: { name: "reference-number", type: "text" },
                          domProps: { value: _vm.form.Subscription },
                          on: {
                            input: function ($event) {
                              if ($event.target.composing) {
                                return
                      ...
                      : _vm._e(),
                    _vm._v(" "),
                    _c("label", { attrs: { for: "message-text" } }, [
                      _vm._v("Note"),
                      _c("small", { staticClass: "danger" }, [
                        _vm._v("(required)"),
                      ]),
                    ...
                    _vm.error != ""
                      ? _c(
                          "div",
                          { staticClass: "infoBox warning note-error" },
              ...
              _c("div", { staticClass: "modal-footer" }, [
                ...
                _vm._v(" "),
                _vm.form.Type != 0 && _vm.form.Note != "" && !_vm.editing
                  ? _c(
                      "button",
                      {
