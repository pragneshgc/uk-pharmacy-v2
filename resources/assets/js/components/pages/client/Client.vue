                       ...
                       <div class="form-column">
                        ...
                        <div class="form-column">
                            <div class="form-group form-group-2">
                                ...
                                <input name="PendingPharmacyURL" v-model="data.PendingPharmacyURL" autocomplete="off" type="text"  placeholder="Pending Pharmacy URL" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-column">
                            <div class="form-group form-group-2">
                                ...
                                <input name="PendingPharmacyEndpoint" v-model="data.PendingPharmacyEndpoint" autocomplete="off" type="text"  placeholder="Pending Pharmacy Endpoint" class="form-control">
                            </div>
                        </div>
                    </div>
