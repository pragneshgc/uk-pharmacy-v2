<template>
    <div class="modal fade show" id="addProduct" tabindex="-1" role="dialog" aria-labelledby="itemEditorLabel"
        aria-modal="true">
        <div class="modal-dialog modal-xl modal-notify modal-info modal-dialog-centered" role="document">
            ...
            <div class="modal-content">
                            ...
                            <div class="col-lg-12 wow fadeIn">
                                <div class="row mb-3">
                                    <div class="col-lg-6">
                                        ...
                                        <input disabled v-model="productCodeEdit.Code" type="text" id="code"
                ...
                <div class="modal-footer">
                    <button :disabled="saving" @click="save()" type="button"
                        class="btn btn-primary waves-effect waves-light">
                        Save
                    </button>

                    <button :disabled="saving" @click="clear()" type="button"
...
export default {
    ...
    mounted() {
        this.emitter.on('product.add', this.populate);
