                        ...
                        <tr>
                            <td style="text-align: center">
                                <div class="product-name"
                                    style="font-size: 14px; text-align: center; margin-top: -3px; line-height: 14px; @if (strlen($product->Name . ' ' . $product->DisplayedQuantity . ' ' . $product->Units) > 45) font-size: 12.5px; @endif">
                                ...
                                <tr>
                                    <td style="height: 70px;vertical-align: top;">
                                        <div class="product-instructions"
                                            style="font-size: 11px; padding: 0px 8px; line-height:11px; font-weight: 700; margin-top: 0px;">
                                            {!! $chunk !!}
                                        </div>
                                    </td>
                                </tr>
